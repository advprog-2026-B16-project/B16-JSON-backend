...
public class WalletServiceImpl implements WalletService {
    ...
    @Override public Wallet createWallet(String userId) { UUID uid = UUID.fromString(userId); return walletRepository.findByUserId(uid).orElseGet(() -> walletRepository.save(new Wallet(uid))); }
    ...
    @Override public Wallet findWallet(String userId) { return walletRepository.findByUserId(UUID.fromString(userId)).orElseThrow(() -> new WalletNotFoundException(userId)); }
}