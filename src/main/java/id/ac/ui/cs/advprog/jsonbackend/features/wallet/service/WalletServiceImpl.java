...
public class WalletServiceImpl implements WalletService {
    ...
    @Override public Wallet createWallet(String userId) { return walletRepository.findByUserId(userId).orElseGet(() -> walletRepository.save(new Wallet(userId))); }
    ...
    @Override public Wallet findWallet(String userId) { return walletRepository.findByUserId(userId).orElseThrow(() -> new WalletNotFoundException(userId)); }
}